...
function btnClicked() {
  ...
  document.getElementById("eng-letter").innerHTML = getLetterGrade(engPercent);
  document.getElementById("soc-letter").innerHTML = getLetterGrade(socPercent);
  document.getElementById("math-letter").innerHTML = getLetterGrade(mathPercent);
  document.getElementById("sci-letter").innerHTML = getLetterGrade(sciPercent);
}
